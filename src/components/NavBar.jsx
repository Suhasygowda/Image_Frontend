        ...
        <div className='flex items-center justify-between py-4'>
            ...
            {user ? (
                ...
                <div className='flex items-center gap-2 sm:gap-5'>
                    <p className='cursor-pointer hover:text-blue-600 transition-colors' onClick={() => navigate('/buy-credit')}>
                        Pricing
                    </p>
                    <button 
                        onClick={() => setShowLogin(true)} 
                        className='bg-zinc-800 text-white rounded-full px-7 py-2 sm:px-8 text-sm cursor-pointer hover:bg-zinc-700 transition-colors'
                    >
                        Login
                    </button>
                </div>
